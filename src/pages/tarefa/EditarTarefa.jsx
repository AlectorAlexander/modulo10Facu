...
const EditarTarefa = ({ handleCloseEditar, idTarefaSelecionada, tarefas, tarefa, setTarefas }) => {
  ...
  const handleEditar = () => {
    ...
    setTimeout(() => {
      ...
      setLoading(false);
      handleCloseEditar();
    }, 1000); // Simula o tempo de processamento da edição
  };
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Tooltip title="Salvar alterações">
                  <Button size="small" variant="contained" onClick={handleEditar} disabled={loading}>
              ...
              <Grid item xs={1}>
                <Tooltip title="Cancelar">
                  <Button size="small" variant="outlined" onClick={handleCloseEditar} disabled={loading}>
                    Cancelar
                  </Button>
                </Tooltip>
              </Grid>
